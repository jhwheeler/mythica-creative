...
const caseStudiesData = [
  {
    ...
    expandedText:"<p>The brand we created centers around heritage, tradition, and legacy – while at the same time expressing the excitement and high-end quality of their unique adventures.</p><br><p>To design the logo, we combined our knowledge of proportions, the relationship between positive and negative spaces, and the classic art of heraldry to craft a strongly recognizable symbol that will stand out in the modern visual jungle. The clean typography resonates beautifully with the main letter, “W”, which we modified to imply the “X” of “Expeditions”. The crest and year of establishment express the tradition and heritage of Wheeler Expeditions’ history.</p><br><p>Designed as an approachable space for adventurers to begin exploring the world in new ways, the Wheeler Expeditions website is an engaging modern platform with a classically elegant style.</p>",
  ...
  },
  {
    ...
    expandedText: "<p>The logo is a graphically strong, communicative symbol based on the harmonious principles of organic design. Combining two modified infinity symbols to form one majestic heart, this dynamic symbol expresses the infinite healing power of love.</p><br><p>The Infinite Love Healing website is a platform for potential students and clients to discover the wide range of services and classes created to further their spiritual development. Its open, airy design and fluid user experience encourage engagement and interaction with the brand.</p>",
  ...
  },
  {
    ...
    expandedText: "<p>After conducting extensive research of their history as well as the current status of the market, we crafted an elegantly timeless brand that authentically expresses the values of the company. We based their logo on classical principles of design and geometry, such as the Golden Ratio, to create a dynamic image conveying harmony and balance.</p><br><p>We digitized 24 color spectrums, each consisting of over 500 individual colors, which their clients now happily use to choose the clothing that best suits them. In addition, we designed an entire curriculum of in-depth information products for the exclusive members of Living Harmony.</p>"
  }
]
