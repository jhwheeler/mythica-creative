import blueprintHero from '../../../public/images/hero/blueprint-hero.jpg';
import mythicaLogo from '../../../public/images/hero/logo_hero.png';
...
export const copy = {
  ...
  audienceText1: "Yes, you've heard it time and time again, and you've already got it done and dusted. But, do you really? Go onto your social media right now and find dwhat your ideal clients search, discuss, and want. Open a text editor and paste some ideas in there. Spend a couple hours researching <em>exactly</em> what they're posting, tweeting, and liking. Paste in your file what your followers share on their walls and create a hot list of their biggest interests.",
